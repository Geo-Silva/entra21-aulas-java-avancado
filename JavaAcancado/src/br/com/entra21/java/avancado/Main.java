	...
	public static void main(String[] args) {
		...
		do {
			...
			case 6:
				...
				new Aula06("Aula 06", new ArrayList<>(Arrays.asList("Aprender Generics","Listar Pessoas", "Adicionar Pessoas", "Editar Pessoa", "Deletar Pessoa"))).aprender();
			...
			case 7:
				...
				topicos.add("Custom Exception");
				new Aula07("Aula 07", null).aprender();
				
				break;
				
			case 8:
				
				ArrayList<String> topicos1 = new ArrayList<>();
				topicos1.add("Listar");
				topicos1.add("Filtrar");
				topicos1.add("Estatística");
				topicos1.add("Ordenar");
				new Aula08("Aula 08", null).aprender();
